...
# https://search.51job.com/list/{},000000,0000,00,9,99,python,2,1.html/format(citylist[cityname])
# https://search.51job.com/list/{},000000,0000,00,9,99,python,2,1.html
# https://search.51job.com/list/{},000000,0000,00,9,99,python,2,1.html
# https://search.51job.com/list/{},000000,0000,00,9,99,web,2,1.
from  urllib.request import Request , urlopen
import re

def get_city_code_with_name(cityName):
...
class Job(object):
    ...
    def get_code_with_url(self):
        url = self.baseUrl + get_city_code_with_name(self.cityName) + \
              ',000000,0000,00,9,99,' + self.jobName + ',2,' + str(self.currentPage) + '.html'
